  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function randomSpin(cl) {
        return color(cl).spin(roundRandom(0, 40)).toString();
      }
      ...
      load(function () {
        ...
        rx.fromEvent(document.getElementById("color"), "change").subscribe(
          function (event) {
    ...
    /***/ function (module, exports) {
      ...
      function createRange(fromRight) {
        return function (start, end, step) {
          ...
          step =
            step === undefined ? (start < end ? 1 : -1) : toNumber(step) || 0;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      function isHTMLCollection(sourceObj) {
        return (
          !!sourceObj && sourceObj.toString() === "[object HTMLCollection]"
        );
      }
